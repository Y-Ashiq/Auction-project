        ...
        <div >
          <div className="row d-flex justify-content-center align-items-center m-5 py-5 ">
            <div className="col-xl-10">
              <div className=" card shadow rounded-3 text-black" style={{borderradius:'5px  ' }}>
                <div className="row g-0">
                    ...
                    <div className="p-md-5 mx-md-4">
                      ...
                      <form className="text-center" onSubmit={this.sendData}>
                        ...
                        <div className="form-outline mb-4">
                           ...
                           <input onChange={this.getFormData} type="email"  name='email'id="form2Example11" className="form-control"/>
                        ...
                        <div className="form-outline mb-4">
                          ...
                          <input  onChange={this.getFormData} type="password" name='password' id="form2Example22" className="form-control" />
                        ...
                        <div className="m-4  text-center" >
                            ...
                            <input style={{backgroundColor:'#ff9d5c'}} className="btn gg btn-lg text-white" type="submit" value="Log in " />
                          </div>
                  ...
                  <div class="col-lg-6 d-flex align-items-center gradient-custom-2 aloo " style={{backgroundColor:'#2081E2 '}}>
